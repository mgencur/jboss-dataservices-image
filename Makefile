...
IMAGE_NAME = datagrid-online-services
...
ifneq ($(CE_DOCKER),)
	...
	IMAGE_FULL_NAME = $(DEV_IMAGE_ORG)/$(IMAGE_NAME)
...
test-remote-openshift: clean prepare-remote-openshift test-functional
